...
exports.Monitor = exports.MonitorMixin = exports.ConditionVariable = exports.ThreadError = exports.MonitorError = void 0;
/**
    ...
    wait(timeout) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield this.monitor._enterForCond(state);
            }
        });
    }
    /**
    ...
    waitWhile(condition, timeout) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (condition()) {
                ...
                const signaled = yield this.wait(remainingTimeout);
                if (!signaled) {
...
class MonitorMixin {
    ...
    static extendObject(obj) {
        ...
        Object.defineProperty(extended, "_wakeupNext", {
            value: monitor._wakeupNext.bind(monitor),
            writable: true,
            enumerable: false,
            configurable: true,
        });
    ...
    enter() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const newOwner = { id: ownerId, count: 1 };
    ...
    synchronize(block) {
        return __awaiter(this, void 0, void 0, function* () {
            const owner = yield this.enter();
            try {
                return yield block(owner, this);
            }
            finally {
                this.exit(owner);
            }
    ...
    _exitForCond() {
        ...
        const state = Object.assign({}, this.owner);
        this.owner = null;
        this.locked = false;
...
exports.MonitorMixin = MonitorMixin;
/**
 ...
 */
class Monitor extends MonitorMixin {
    /**
    ...
    synchronize(block) {
        const _super = Object.create(null, {
            synchronize: { get: () => super.synchronize }
        });
        return __awaiter(this, void 0, void 0, function* () {
            if (block.length === 0) {
                // Block doesn't take parameters - use simple wrapper
                return _super.synchronize.call(this, () => __awaiter(this, void 0, void 0, function* () { return yield block(); }));
            }
            else {
                // Block takes parameters - pass them through
                return _super.synchronize.call(this, block);
            }
        });
    }
}
